...
Public Class Form1
    ...
    Private Sub InitChamp()
        ...
        ChampList.Add(New Champ("Cho'Gath", "チョ＝ガス", LANE_TOP, LANE_MID, LANE_JUNGLE, 0, 0, ROLE_TANK, ROLE_MAGE))
        ...
        ChampList.Add(New Champ("Kog'Maw", "コグ＝マウ", LANE_ADC, LANE_JUNGLE, 0, 0, 0, ROLE_MARKSMAN, ROLE_MAGE))
        ...
        ChampList.Add(New Champ("Malphite", "マルファイト", LANE_TOP, LANE_JUNGLE, 0, 0, 0, ROLE_TANK, ROLE_FIGHTER))
        ChampList.Add(New Champ("Malzahar", "マルザハール", LANE_MID, LANE_JUNGLE, LANE_TOP, 0, 0, ROLE_MAGE, ROLE_ASSASSIN))
        ChampList.Add(New Champ("Maokai", "マオカイ", LANE_TOP, LANE_JUNGLE, 0, 0, 0, ROLE_TANK, ROLE_MAGE))
        ...
        ChampList.Add(New Champ("Mordekaiser", "モルデカイザー", LANE_TOP, LANE_MID, LANE_JUNGLE, 0, 0, ROLE_FIGHTER, ROLE_MAGE))
        ...
        ChampList.Add(New Champ("Nunu", "ヌヌ", LANE_JUNGLE, LANE_SUP, 0, 0, 0, ROLE_SUPPORT, ROLE_FIGHTER))
        ...
        ChampList.Add(New Champ("Pantheon", "パンテオン", LANE_TOP, LANE_JUNGLE, 0, 0, 0, ROLE_FIGHTER, ROLE_ASSASSIN))
        ChampList.Add(New Champ("Poppy", "ポッピー", LANE_TOP, LANE_JUNGLE, LANE_SUP, 0, 0, ROLE_FIGHTER, ROLE_ASSASSIN))
        ChampList.Add(New Champ("Quinn", "クイン", LANE_TOP, LANE_ADC, LANE_JUNGLE, 0, 0, ROLE_MARKSMAN, ROLE_FIGHTER))
        ...
        ChampList.Add(New Champ("Sion", "サイオン", LANE_TOP, LANE_JUNGLE, LANE_SUP, 0, 0, ROLE_FIGHTER, ROLE_MAGE))
        ...
        ChampList.Add(New Champ("Taliyah", "タリヤ", LANE_MID, 0, 0, 0, 0, ROLE_MAGE, ROLE_SUPPORT))
        ...
        ChampList.Add(New Champ("Trundle", "トランドル", LANE_TOP, LANE_SUP, LANE_JUNGLE, 0, 0, ROLE_FIGHTER, ROLE_TANK))
        ...
        ChampList.Add(New Champ("Twitch", "トゥイッチ", LANE_ADC, LANE_JUNGLE, 0, 0, 0, ROLE_MARKSMAN, ROLE_ASSASSIN))
        ChampList.Add(New Champ("Udyr", "ウディア", LANE_JUNGLE, 0, 0, 0, 0, ROLE_FIGHTER, ROLE_TANK))
        ChampList.Add(New Champ("Urgot", "アーゴット", LANE_TOP, LANE_ADC, LANE_MID, 0, 0, ROLE_MARKSMAN, ROLE_TANK))
        ...
        ChampList.Add(New Champ("Zac", "ザック", LANE_JUNGLE, 0, 0, 0, 0, ROLE_TANK, ROLE_FIGHTER))
